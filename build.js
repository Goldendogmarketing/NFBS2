    ...
    <nav class="bg-white shadow-md sticky top-0 z-50">
        <div class="container mx-auto px-6 py-3 flex justify-between items-center">
            ...
            <div class="hidden lg:flex items-center space-x-8">
                ...
                <a href="${prefix}services/steel-buildings.html" class="hover:text-secondary transition font-medium">Steel Buildings</a>
        ...
        <div id="mobile-menu" class="hidden lg:hidden border-t bg-white px-6 pb-4">
            ...
            <a href="${prefix}services/steel-buildings.html" class="block py-3 border-b border-gray-100 font-medium hover:text-secondary transition">Steel Buildings</a>
